...
/**
 * If the board page or the contact page has already been called, nothing happens, otherwise the Add Task in the sidebar is colored in dark blue.
 */

function addTaskPage() {
  let boardActive = document.getElementById("sidebar_board_mobile");
  let contactActive = document.getElementById("sidebar_contact_mobile");
  if (boardActive.classList.contains("background-color")) {
    return;
  } else if (contactActive.classList.contains("background-color")) {
    return;
  } else {
