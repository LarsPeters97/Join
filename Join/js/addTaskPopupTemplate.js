/**
 * @param {string} progressStatus from the processing step name, e.g. todo.
 * @returns the html code to create a new task on the board.html page and or the contact.html page.
 */
  ...
  return /*html*/ `
    ...
    <div class="add_task_popup">
        <div class="add-task-mobile-head">
            ...
            <button class="create-btn btns-clear-and-create create-btn-responsive" onclick="createNewTask('${progressStatus}')">Create
                <img src="./assets/img/create-check.svg" id="create-responsive">
            </button>
        </div>
        <div class="pop-up-body">
            <div class="headline-and-close">
                <h1 class="headline-task headline-task-smaller">Add Task</h1>
            ...
            <div class="flex change-direction">
                <div class="left-side flex column">
                    <div class="title flex column margin-for-fields">
                        ...
                        <input class="input-text-type width-f" type="text" minlength="2" maxlength="50" placeholder="Enter a title"
                    ...
                    <div class="description flex column margin-for-fields">
                        ...
                        <textarea class="width-f" name="description" id="description" minlength="2" maxlength="500"
                ...
                <div class="right-side flex column">
                    ...
                    <div class="flex column margin-for-fields">
                        ...
                        <div id="subtasks-section" class="width-f">
                            <div class="input-text-type subtask" id="subtask-before" onclick="changeSubtaskInputField()">
